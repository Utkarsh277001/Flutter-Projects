...
class _OwnerProfilePageState extends State<OwnerProfilePage> {
  ...
  Future<void> _getUserData() async {
    ...
    setState(() {
      // isgGymReg = prefs.getString('doesSubs') ?? 'No';
      name = prefs.getString('ownerName') ?? '';
      gender = prefs.getString('ownerGender') ?? '';
      age = prefs.getString('ownerAge') ?? '';
      email = prefs.getString('ownerEmail') ?? '';
      totalgym = prefs.getString('totalgym') ?? '';
      len = prefs.getString('len') ?? '0';
...
class SubscriptionDetails extends StatefulWidget {
  const SubscriptionDetails({key, required this.sDate});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text(
            'No. of Gym Resgister : ${widget.sDate}',
            style: TextStyle(fontSize: 14, color: Colors.grey[700]),
          ),
          SizedBox(height: 16),
          Align(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text(
            'Please registered your gym on our platform',
            style: TextStyle(fontSize: 14, color: Colors.grey[700]),
          ),
          SizedBox(height: 16),
          Align(
